...
from fixtures import ThingFactory2DB, ThingTypeFactory2DB, SensorFactory2DB, ActuationDictFactory, \
    ...
    ContextAwarenessRuleFactory2DB
...
def assert_actuations(actuation_api, actuation_db):
    ...
    assert actuation_db["context_awareness_rule_name"] == \
           str(actuation_api["context_awareness_rule_name"])
...
@pytest.fixture
def create_context_awareness_rule_2():
    return ContextAwarenessRuleFactory2DB(name="Rule2", sensor_observed_name="RainSensorA",
                                          operation_type=ContextAwarenessOperationEnum.not_equal,
                                          value_to_compare_boolean=True)


@pytest.fixture
def create_context_awareness_rule():
    return ContextAwarenessRuleFactory2DB(name="Rule1", sensor_observed_name="RainSensorA",
...
def test_get_actuations_all(api_client, orm_client, create_observation,
                            create_context_awareness_rule, create_context_awareness_rule_2,
    ...
    actuation_2 = ActuationFactory2DB(observation_id=test_input_2[0],
                                      context_awareness_rule_name=test_input_2[1],
...
def test_get_actuation(api_client, orm_client, create_observation, create_context_awareness_rule,
                       test_input):
    assert orm_client.session.query(Actuation).count() == 0
    actuation_1 = ActuationFactory2DB(observation_id=test_input[0],
                                      context_awareness_rule_name=test_input[1],
...
def test_add_actuation(api_client, orm_client, create_observation, create_context_awareness_rule,
                       test_input):
    assert orm_client.session.query(Actuation).count() == 0
...
def test_delete_actuation(api_client, orm_client, create_observation, create_context_awareness_rule,
                          test_input):
    assert orm_client.session.query(Actuation).count() == 0
    actuation_1 = ActuationFactory2DB(observation_id=test_input[0],
                                      context_awareness_rule_name=test_input[1],
