...
from fixtures import FeatureOfInterestFactory2DB, ActuatablePropertyFactory2DB, ActuatorFactory2DB, \
    ...
    ObservationFactory2DB, ContextAwarenessRuleFactory2DB, ActuatorActuationFactory2DB, \
    ActuationFactory2DB
...
@pytest.fixture
def create_actuation(create_observation, create_context_awareness_rule):
    return ActuationFactory2DB(observation_id=0, context_awareness_rule_name="Rule1",
