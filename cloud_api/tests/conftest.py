...
from fixtures import ThingFactory2DB, ThingTypeFactory2DB, ObservationFactory2DB, \
    ...
    ObservationFloatFactory2DB, ContextAwarenessRuleFactory2DB, LocationFactory2DB, \
    ...
    ActuatorActuationFactory2DB, ThingStatusFactory2DB
...
def api_client():
    ...
    ContextAwarenessRuleFactory2DB._meta.sqlalchemy_session = db.session
...
def orm_client(api_client):
    ...
    ContextAwarenessRuleFactory2DB.reset_sequence(value=0, force=True)
