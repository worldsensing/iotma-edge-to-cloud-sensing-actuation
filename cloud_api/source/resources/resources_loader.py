...
from resources.api_handlers import ThingTypeHandler, ThingHandler, \
    ObservationHandler, ContextAwarenessRulesHandler, LocationHandler, ActuatablePropertyHandler, \
    ActuationHandler, ActuatorHandler, FeatureOfInterestHandler, ObservablePropertyHandler, \
    PlatformHandler, SensorHandler
...
class Resources:
    ...
    def init_cors(app):
        cors_resources = [r"/actuatable-properties/*", r"/actuations/*", r"/actuators/*",
                          r"/context-awareness-rules/*", r"/features-of-interest/*",
    ...
    def load_resources(api):
        ...
        api.add_resource(ContextAwarenessRulesHandler.ContextAwarenessRules,
                         "/context-awareness-rules/",
                         strict_slashes=False)

        api.add_resource(ContextAwarenessRulesHandler.ContextAwarenessRule,
                         "/context-awareness-rules/<string:context_awareness_rule_name>",
                         strict_slashes=False)
